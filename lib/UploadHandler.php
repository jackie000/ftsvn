...
class UploadHandler{
    ...
    protected function get_upload_path_dir($file_name = null, $version = null) {
        ...
        if( $file_name ) {
        	$file_name = date('Ymd') . '/' . substr( sprintf( "%010d", crc32( $file_name ) & 0xFFFFFFFF ), 0, 3 ) . '/';
        }
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        if( $file_name ) {
        	$file_name = date('Ymd') . '/' . substr( sprintf( "%010d", crc32( $file_name ) & 0xFFFFFFFF ), 0, 3 ) . '/' . $file_name;
        }
        return $this->options['upload_dir'].$this->get_user_path()
            .$version_path.$file_name;
    }
    ...
    protected function get_download_url($file_name, $version = null, $direct = false) {
        ...
        if( $file_name ) {
        	$file_name = date('Ymd') . '/' . substr( sprintf( "%010d", crc32( $file_name ) & 0xFFFFFFFF ), 0, 3 ) . '/' . rawurlencode($file_name);
        }
    ...
    protected function get_scaled_image_file_paths($file_name, $version) {
        $file_path = $this->get_upload_path($file_name);
        if (!empty($version)) {
            $version_dir = $this->get_upload_path_dir($file_name, $version);
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $upload_dir = $this->get_upload_path_dir($file->name);
            if (!is_dir($upload_dir)) {
